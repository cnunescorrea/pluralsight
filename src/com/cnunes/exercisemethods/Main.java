package com.cnunes.exercisemethods;
...
public class Main {
    ...
    private static void variableLengthParameterList() {
        ...
        Passenger camila = new Passenger(0, 1);
        Passenger john = new Passenger(0, 2);
        System.out.println("Calling f.addPassengers(luisa, camila, john)");
        f.addPassengers(luisa, camila, john);
